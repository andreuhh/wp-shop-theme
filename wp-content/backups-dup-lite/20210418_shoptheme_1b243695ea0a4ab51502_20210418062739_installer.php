...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210418_shoptheme_1b243695ea0a4ab51502_20210418062739_archive.zip';
	const ARCHIVE_SIZE		 = '102363932';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1b24369-18062739';
    const SECONDARY_PACKAGE_HASH = 'c67ce4b-18062739';
	const VERSION			 = '1.4.0';
